  ...
  return (
    ...
    <div className='flex justify-center '>
      ...
      <div className='flex items-center gap-8 bg-white p-4 rounded-full relative'>
        <li className={`list-none z-10 ${toggle === 1 ? '' : 'text-white'}`}><button onClick={() => switchToggle(0)}>Recent</button></li>
        <li className={`list-none z-10 ${toggle === 1 ? 'text-white' : ''}`}><button onClick={() => switchToggle(1)}>Details</button></li>
        <span
